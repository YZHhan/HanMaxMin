package com.han.hanmaxmin.common.widget.cameraview.cropper;
...
import com.han.hanmaxmin.common.widget.cameraview.cropper.cropwindow.CropOverlayView;
import com.han.hanmaxmin.common.widget.cameraview.cropper.cropwindow.edge.Edge;
import com.han.hanmaxmin.common.widget.cameraview.cropper.util.ImageViewUtil;

/*
 * @Author yinzh
 * @Date   2018/6/20 16:42
 * @Description: 剪裁图像的View。
 */
public class CropImageView extends FrameLayout{
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        Log.i("CropImageView","w onSizeChanged= " + w + "h onSizeChanged= " + h);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBitmap != null) {
            Log.i("CropImageView","widthMeasureSpec onMeasure= " + widthMeasureSpec + "heightMeasureSpec onMeasure= " + heightMeasureSpec);
            ...
            // simply picture size
                ...
                Log.i("CropImageView","desiredWidth = " + desiredWidth + "desiredHeight = " + desiredHeight);
            }
            ...
            Log.i("CropImageView","mLayoutWidth = " + mLayoutWidth + "mLayoutHeight" + mLayoutHeight);

            // MUST CALL THIS
            setMeasuredDimension(mLayoutWidth, mLayoutHeight);

        } else {
            Log.i("CropImageView","widthSize = " + widthSize + "heightSize" + heightSize);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mLayoutWidth > 0 && mLayoutHeight > 0) {
            ...
            Log.i("CropImageView","mLayoutWidth onLayout= " + mLayoutWidth + "mLayoutHeight onLayout= " + mLayoutHeight);
