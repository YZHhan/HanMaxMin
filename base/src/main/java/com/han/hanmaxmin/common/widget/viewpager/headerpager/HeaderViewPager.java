package com.han.hanmaxmin.common.widget.viewpager.headerpager;
...
import com.han.hanmaxmin.common.widget.viewpager.headerpager.base.SizeSensitiveLinearLayout;
import com.han.hanmaxmin.common.widget.viewpager.headerpager.base.TranslatableLinearLayout;
...
public class HeaderViewPager extends FrameLayout implements OuterScroller {
    ...
    private HanViewPager mViewPager;
    ...
    public void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.han_layout_header_viewpager, this, true);
        ...
        mViewPager = (HanViewPager) findViewById(R.id.mhvp_pager);
